   ...
   <% foreach (ProductSummaryView product in Model.Products){ %>      
      ...
      <img class="item-productimage" 
          ...
          <div class="item-productname">
            <%= Html.ActionLink(Html.Encode(product.BrandName) + " " + Html.Encode(product.Name), "Detail", "Product", new { id = product.Id }, null)%></div>
...
<span class="item-displayoptions-pages">
   <span id="pageLinksBottom">
     <%=Html.BuildPageLinksFrom(Model.CurrentPage, Model.TotalNoOfPages, x => "JavaScript:displayPage("+ x +")")%></span>   
 </span>  
