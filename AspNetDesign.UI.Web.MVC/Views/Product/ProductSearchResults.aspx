<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ProductCatalog.Master" Inherits="System.Web.Mvc.ViewPage<ProductSearchResultView>" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="productResults" class="col-xs-10">
        <ol class="breadcrumb">
            <li><a href="#">Categories</a></li>
            <li><a href="#"><%=Html.Encode(Model.SelectedCategoryName) %></a></li>
        </ol>
        <div class="col-md-4">
        ...
        <div class="col-md-4 col-md-offset-4">
            Products found 
               <span id="numberOfProductsFound"><%=Html.Encode(Model.NoOfTitlesFound) %></span>
            <span id="pageLinksTop">
                <%=Html.BuildPageLinksFrom(Model.CurrentPage, 
                                          Model.TotalNoOfPages, 
        ...
        <% foreach (ProductSummaryView product in Model.Products)
           { %>
        <div id="items" class="col-sm-6 col-md-4">
            <div class="thumbnail">
        ...
        <p>
            <%=Html.BuildPageLinksFrom(Model.CurrentPage, Model.TotalNoOfPages, x => "JavaScript:displayPage("+ x +")")%>
        </p>
        <p>&nbsp;</p>
